    ...
    >
        <div class="mb-4 rounded-lg border border-gray-200 bg-white p-4">
            <div class="relative">
                <input
                    type="file"
                    class="focus:border-primary relative m-0 block w-full min-w-0 flex-auto rounded border border-solid border-gray-200 bg-clip-padding px-3 py-[0.32rem] text-base font-normal text-gray-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-gray-100 file:px-3 file:py-[0.32rem] file:text-gray-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem] hover:file:bg-gray-200 focus:text-gray-700 focus:outline-none"
                    multiple
            ...
            >
                <dd class="mt-1 text-sm text-gray-900">
                    <div class="w-full">
                        ...
                        >
                            <template
                                x-for="(file, index) in uploadedFiles"
                                :key="file.id"
                            >
                                <li class="relative">
                                    <div
                                        class="absolute inset-0 z-10 opacity-20 transition-all"
            ...
            >
                <div class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                    <ul role="list" class="divide-y divide-gray-100 rounded-md">
                        <li
                            class="flex items-center justify-between border-b bg-gray-50 py-4 pl-4 pr-5 text-sm leading-6"
                        >
                            <div class="flex w-0 flex-1 items-center">
                                <x-heroicon-o-document
                                    class="h-5 w-6 flex-shrink-0 text-gray-400"
                                />
                        ...
                        @foreach ($this->documents as $document)
                            ...
                            >
                                <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div
                                        class="ml-4 flex min-w-0 flex-1 items-center gap-2"
                                    >
                                        <span class="truncate font-medium">
                                            {{ $document->filename }}
                                        </span>
